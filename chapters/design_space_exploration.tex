...
\todo{Kishore: what about time to do the partitioning using KD tree?  Is that in the critical path?  Some comments about that is necessary to justify the choice.}
