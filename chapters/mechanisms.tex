...
\subsection{Interface provided to control plane\todo{Rename to "A New Mechanism For ..."}}
...
\todo{ch 3 there was no linkage and forward reference to the detailed design choice explorations to be presented in ch 4.  You should revise ch 3 as we discussed yesterday.  Give summary results to show your new mechanisms out-perform state-of-the-art in ch3.  Give forward reference to ch 4 saying that detailed design choice explorations are carried out for those mechanisms.}